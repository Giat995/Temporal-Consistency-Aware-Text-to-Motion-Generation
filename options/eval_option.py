...
class EvalT2MOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--out_dir', type=str, default='./output/eval', help='models are saved here.')
        ...
        self.parser.add_argument('--frb_dir', type=str, default='./output/frb', help='models are saved here.')
        ...
        self.parser.add_argument('--frb_name', type=str, default='./output/frb', help='models are saved here.')
        self.is_train = False
