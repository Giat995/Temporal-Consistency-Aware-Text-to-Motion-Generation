...
class FRBT2MOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--meta_dir', type=str, default='./checkpoints/t2m/VQVAE/meta', help='Meta directory')
        self.parser.add_argument('--lr', type=float, default=2e-3, help='Learning rate')
        self.parser.add_argument('--weight_decay', default=0.0, type=float, help='weight decay')
        self.parser.add_argument('--warm_up_iter', default=10000, type=int, help='number of total iterations for warmup')
        self.parser.add_argument('--milestones', default=[150000, 250000], nargs="+", type=int, help="learning rate schedule (iterations)")
        self.parser.add_argument('--gamma', default=0.1, type=float, help="learning rate decay")
        self.parser.add_argument('--max_epoch', default=50, type=int, help='number of total epochs to run')
        self.parser.add_argument('--max_iter', default=300000, type=int, help='number of total iterations to run')
        self.parser.add_argument('--is_continue', action="store_true", help='Name of this trial')
        self.parser.add_argument('--recons_loss', type=str, default='l1_smooth', help='reconstruction loss')
        self.parser.add_argument('--loss_vel', type=float, default=0.5, help='hyper-parameter for the velocity loss')
        self.parser.add_argument('--print_iter', default=500, type=int, help='print interval')
        self.parser.add_argument('--eval_iter', default=5000, type=int, help='evaluate interval')
        self.parser.add_argument('--save_latest', default=500, type=int, help='iter save latest model frequency')
        ...
        self.parser.add_argument('--out_dir', type=str, default='./output/frb', help='models are saved here.')
        self.parser.add_argument('--mtrans_dir', type=str, default='./output/mtrans', help='models are saved here.')
        self.parser.add_argument('--vq_dir', type=str, default='./output/vq', help='models are saved here.')
        self.parser.add_argument('--rtrans_dir', type=str, default='./output/rtrans', help='models are saved here.')

        self.parser.add_argument('--mtrans_name', type=str, default='./output/mtrans', help='models are saved here.')
        self.parser.add_argument('--rtrans_name', type=str, default='./output/res', help='models are saved here.')
        self.is_train = False
