...
def arg_parse(is_train=False):
    ...
    parser.add_argument('--max_iter', default=300000, type=int, help='number of total iterations to run')
    # parser.add_argument('--total_iter', default=None, type=int, help='number of total iterations to run')
    parser.add_argument('--warm_up_iter', default=10000, type=int, help='number of total iterations for warmup')
    ...
    parser.add_argument('--print_iter', default=500, type=int, help='print interval')
    parser.add_argument('--eval_iter', default=5000, type=int, help='evaluate interval')
    parser.add_argument('--out_dir', type=str, default="./output", help='Directory of output')
    ...
    parser.add_argument('--vq_name', type=str, default="VQVAE", help='Name of this trial')
    ...
    #tcc
    parser.add_argument('--tcc_flag', action='store_true', help='use tcc loss')
    parser.add_argument('--loss_tcc', type=float, default=0.1, help='hyper-parameter for the tcc loss')
    parser.add_argument('--stochastic_matching', action='store_true', help='stochastic or deterministic')
    parser.add_argument('--normalize_embeddings', action='store_true', help='embedding normalization')
    parser.add_argument('--loss_type', type=str, default='classification', choices = ['classification', 'regression_mse', 'regression_mse_var', 'regression_huber'], help='loss type of tcc')
    parser.add_argument('--similarity_type', type=str, default='l2', choices = ['l2', 'cosine'], help='similarity calculation method')
    parser.add_argument('--num_cycles', type=int, default=20, help='num of cycles in stochastic')
    parser.add_argument('--cycle_length', type=int, default=2, help='cycle length in stochastic')
    parser.add_argument('--tcc_loc', type=str, default='encoder', choices = ['encoder', 'decoder'], help='the location of tcc loss')
    parser.add_argument('--projection_flag', type=int, default=0, help='embedding normalization')
    parser.add_argument('--frb', action='store_true', help='embedding normalization')
