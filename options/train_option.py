...
class TrainT2MOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--print_iter', type=int, default=500, help='Frequency of printing training progress, (iteration)')
        ...
        self.parser.add_argument('--out_dir', type=str, default='output/mtrans', help='Output directory')
        self.parser.add_argument('--vq_dir', type=str, default='./output/vq', help='VQ directory')
        self.parser.add_argument('--meta_dir', type=str, default='./checkpoints/t2m/VQVAE/meta', help='Meta directory')


        self.is_train = True

class TrainT2MOptionsRes(BaseOptions):
    def initialize(self):
        BaseOptions.initialize(self)
        self.parser.add_argument('--batch_size', type=int, default=64, help='Batch size')
        self.parser.add_argument('--max_epoch', type=int, default=500, help='Maximum number of epoch for training')
        ...
        self.parser.add_argument('--eval_every_e', type=int, default=10, help='Frequency of animating eval results, (epoch)')
        self.parser.add_argument('--save_latest', type=int, default=500, help='Frequency of saving checkpoint, (iteration)')
        self.parser.add_argument('--out_dir', type=str, default='output/rtrans', help='Output directory')
        self.parser.add_argument('--vq_dir', type=str, default='./output/vq', help='VQ directory')
        self.parser.add_argument('--meta_dir', type=str, default='./checkpoints/t2m/VQVAE/meta', help='Meta directory')
